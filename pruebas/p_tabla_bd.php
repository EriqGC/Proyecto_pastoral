<?php
session_start();
include '../pages/permisos.php'; // Asegúrate de incluir tu archivo de permisos

// Obtener el puesto del usuario actual
$puestoUsuario = Permisos::obtenerPuesto($_SESSION['id']);

// Definir qué pestañas puede ver cada puesto
$puestosPermitidos = [
    'Administrador' => ['supervisor', 'coordinador', 'administrador'],
...
<body>
    <div class="container">
        ...
        <div class="tab-container">
            <?php if (in_array('supervisor', $puestosPermitidos[$puestoUsuario])): ?>
                <div class="tab active" data-tab="supervisor">Supervisor</div>
            <?php endif; ?>

            <?php if (in_array('coordinador', $puestosPermitidos[$puestoUsuario])): ?>
                <div class="tab <?= !in_array('supervisor', $puestosPermitidos[$puestoUsuario]) ? 'active' : '' ?>"
                    data-tab="coordinador">Coordinador</div>
            <?php endif; ?>

            <?php if (in_array('administrador', $puestosPermitidos[$puestoUsuario])): ?>
                <div class="tab <?= (!in_array('supervisor', $puestosPermitidos[$puestoUsuario]) && !in_array('coordinador', $puestosPermitidos[$puestoUsuario])) ? 'active' : '' ?>"
                    data-tab="administrador">Administrador</div>
            <?php endif; ?>
        </div>
                    ...
                    <tbody>
                        ...
                        foreach ($participantes as $index => $participante) {
                            ...
                            foreach ($participante['asistencia'] as $day => $checked) {
                                ...
                                echo "<input type='checkbox' class='attendance-checkbox' data-participant='$index' data-day='$day' $checkedAttr>";
                            }
                            echo "</td>";
                            echo "</tr>";
                        }
        ...
        <!-- Vista Coordinador -->
        <?php if (in_array('coordinador', $puestosPermitidos[$puestoUsuario])): ?>
            <div id="coordinador" class="content <?= !in_array('supervisor', $puestosPermitidos[$puestoUsuario]) ? 'active' : '' ?>">
        ...
        <?php if (in_array('administrador', $puestosPermitidos[$puestoUsuario])): ?>
            <div id="administrador" class="content <?= (!in_array('supervisor', $puestosPermitidos[$puestoUsuario]) && !in_array('coordinador', $puestosPermitidos[$puestoUsuario])) ? 'active' : '' ?>">
