...
function initDayOfWeek(parent, selectedDate, weekDay) {
    ...
    const calendarDayOfWeekDayButtonElement = calendarDayOfWeekElement.querySelector("[data-week-calendar-day-of-week-button]");
    ...
    if (isTheSameDay(weekDay, today())) {
        calendarDayOfWeekDayButtonElement.classList.add("week-calendar__day-of-week-button--highlight");
    }
